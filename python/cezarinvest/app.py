...
class ceZarInvest(toga.App):
    ...
    async def calculate_interest(self, widget):
        ...
        self.result_label.text = f"""Votre placement initial de {capital_base} €, plus un montant de \n{month_input} € versé une fois par mois, à un taux d’intérêt \n annualisé de {rate_input} % vaudra {capital_final} € dans 5 ans """
